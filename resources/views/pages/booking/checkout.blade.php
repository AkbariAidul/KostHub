    ...
    @else
        ...
        <div class="px-6 py-6 mt-4 pb-32">
            <div class="flex items-center gap-4 mb-6">
                <a href="{{ url()->previous() }}" class="w-10 h-10 bg-white border border-slate-100 rounded-full flex items-center justify-center shadow-sm">
                ...
                <div class="fixed bottom-6 left-0 right-0 px-6 z-50">
                    <div class="bg-[#1E293B] rounded-[28px] p-4 pl-6 flex items-center justify-between shadow-2xl">
                        <div class="flex flex-col">
                            <span class="text-xs text-slate-400">Total Bayar</span>
                            <span class="font-bold text-white text-lg" id="bottomTotalDisplay">Rp 0</span>
                        </div>
                        <button type="submit" class="bg-[#4FA8C0] text-white px-6 py-3 rounded-full font-bold text-sm hover:bg-[#3d8b9f] transition-all">
                            Bayar Sekarang
                        </button>
                    </div>
                </div>
